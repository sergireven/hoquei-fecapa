-- ═══════════════════════════════════════════════════════════════════════════
-- Fix trigger: always recalculate master_key when slug/name/birth_date change
-- Ensures that updated player names are correctly deduped into player_masters
-- ═══════════════════════════════════════════════════════════════════════════
...
COMMENT ON FUNCTION public.ensure_player_master_id IS 'Automatically assigns or updates player_master_id. Recalculates master_key whenever slug, name, or birth_date change.';
